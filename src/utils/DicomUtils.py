...
from src.configuration.config import JPEG_TEMP_PATH
...
def saveDicomAsJPEG(image_path):
    ...
    fd, jpeg_path = tempfile.mkstemp(suffix=".jpeg", dir=JPEG_TEMP_PATH, prefix='tmp')

    cv2.imwrite(jpeg_path, scaled_image)
    return jpeg_path
